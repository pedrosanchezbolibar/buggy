...
public class Prototype extends ResourceReader {
	 ...
	 */
	public String getPrototype(final String filename, final PrototypeParams params) throws IOException {

		String eol = params.get("EOL");
		if (eol == null) {
			eol = "";
		}
		...
		for (final PrototypeParam entry : params) {
			if (entry.getValue() != null) {
				final StringBuilder sb = new StringBuilder("@");
				sb.append(entry.getKey());
				sb.append('@');
				output = output.replaceAll(sb.toString(), entry.getValue());
			}
		}
